            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="px-2 py-1 text-xs rounded-full bg-green-500/10 text-green-500 font-medium">
                  {t('local.components.providerCard.localTag')}
                </span>
              </div>
              ...
              {provider.settings.enabled && (
                <div className="space-y-2">
                  <label className="text-sm font-medium text-bolt-elements-textPrimary">
                    {t('local.components.providerCard.apiEndpoint')}
                  </label>
                  {isEditing ? (
                    <input
                      type="text"
                      defaultValue={provider.settings.baseUrl}
                      placeholder={t('local.components.providerCard.baseUrlPlaceholder', { name: provider.name })}
                    ...
                    >
                      <div className="flex items-center gap-3 text-bolt-elements-textSecondary group-hover:text-bolt-elements-textPrimary">
                        ...
                        <span className="font-mono">
                          {provider.settings.baseUrl || t('local.components.providerCard.clickToSetBaseUrl')}
                        </span>
                      </div>
                    </button>
                  )}
